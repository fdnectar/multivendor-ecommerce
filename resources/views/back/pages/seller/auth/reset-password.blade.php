...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Seller Reset Password')
        ...
        <div class="w-100">
            <div class="d-flex flex-column h-100">
                ...
                <div class="auth-content my-auto">
                    ...
                    <form class="mt-4" action="{{ route('seller.reset-password-handler', ['token'=>request()->token]) }}" method="POST">
                        @csrf
                        @if(Session::get('fail'))
