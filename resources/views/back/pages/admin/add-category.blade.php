...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="" action="{{ route('admin.manage-categories.store-category') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    @if(Session::get('success'))
                        <div class="alert alert-success alert-top-border alert-dismissible fade show" role="alert">
                            <i class="mdi mdi-check-all me-3 align-middle text-success"></i><strong>Category Added</strong> - {{ Session::get('success') }}
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    @endif
                    ...
                    <div class="row">
                        <div class="col-md-7 mb-3">
                            <div class="">
                                ...
                                <input type="text" class="form-control" id="category_name" name="category_name" value="{{ old('category_name') }}" placeholder="Enter categroy name">
                            </div>
                            @error('category_name')
                        ...
                        <div class="col-md-7">
                            <div class="mb-2 mt-1" style="max-width: 150px;">
                                <img src="" class="img-thumbnail" id="category_img_preview" alt="">
                            </div>
                        </div>
